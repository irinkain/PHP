                        ...
                        <form method="post" action="{{route('posts.update', $post->id)}}">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" placeholder="Name" name="text" value="{{old('title', $post->text)}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Post Views</label>
                                    <input type="name" class="form-control" placeholder="Name" name="views"value="{{old('title', $post->views)}}">
                                </div>
                                <div class="form-group">
